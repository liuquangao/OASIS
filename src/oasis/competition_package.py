...
from oasis.models.analysis import AnalysisRunSummary
from oasis.models.assessment import AssessmentJob
...
def _plot_timeline(job: AssessmentJob, path: Path) -> None:
    ...
    axis.set_title("OASIS Agent execution and validation timeline", loc="left", fontweight="bold")
    fig.tight_layout()
