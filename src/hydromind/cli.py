...
from hydromind import __version__
from hydromind.domain.areas import list_supported_areas, resolve_area
from hydromind.integrations.sepa import SepaTimeSeriesClient
from hydromind.models.analysis import PriorityWeights
from hydromind.runtime import build_analysis_service, run_agent
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(prog="hydromind")
