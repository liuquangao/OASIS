...
from core_analyst.workflows.hydromind_real_data import build_hydromind_input_sources
...
class CoreAnalystCurrentHazard:
    ...
    def _refresh_sync(self) -> CurrentHazardSnapshot:
        ...
        sources = build_hydromind_input_sources(
            self._input_dir,
    ...
    def _lookup_sync(
        ...
        return HazardLookupResult(
            ...
            provider="HydroMind Core Analyst with latest SEPA rainfall",
            dataset=self._layer,
