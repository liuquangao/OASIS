...
from hydromind.domain.rainfall import maximum_rolling_rainfall, rainfall_total
from hydromind.domain.water_levels import relative_level_context
from hydromind.models.hydrometry import (
    MonitoringStation,
    WaterLevelAreaSummary,
    WaterLevelReading,
    WaterLevelSummary,
)
from hydromind.models.provenance import DataProvenance
from hydromind.models.rainfall import (
        ...
        *,
        ...
        return LatestRainfallAreaSummary(
            ...
            provenance=DataProvenance(
                ...
                licence=None,
                integration="hydromind.integrations.sepa.SepaTimeSeriesClient.latest_rainfall_near_location",
            ),
            warnings=warnings,
        )
    ...
    async def recent_level_summary(
        ...
        return WaterLevelSummary(
            ...
            provenance=DataProvenance(
                ...
                licence=None,
                integration="hydromind.integrations.sepa.SepaTimeSeriesClient",
            ),
            warnings=warnings,
        )
